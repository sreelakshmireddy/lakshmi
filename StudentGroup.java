...
if(this.students[index]<0&&this.students[index]>=length) throw new  IllegalArgumentException("invalid index");
	}
	...
	public Student[] getByBirthDate(Date date) {
		// Add your implementation here
                    if(date==null) throw new IllegalArgumentException("Date should not be null.Enter valid date");
                   this.students.birthDate=date;
